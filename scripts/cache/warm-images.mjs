 ...
 *
 * Usage:
 *   node scripts/cache/warm-images.mjs --limit=4000          # warm 4000 images
 *   node scripts/cache/warm-images.mjs --types=clearart      # only clearart
 *   node scripts/cache/warm-images.mjs --skip=4000           # skip first N (resume)
 *   node scripts/cache/warm-images.mjs --since-days=7        # only recent fanarts
 *   node scripts/cache/warm-images.mjs --concurrency=8       # tune parallelism
 *   node scripts/cache/warm-images.mjs --dry-run             # list, don't fetch
 *   node scripts/cache/warm-images.mjs --budget=1000         # stop after N NEW transformations
 *
