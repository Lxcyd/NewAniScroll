...
//
//   node scripts/player-map/purge-heuristic-player-map.mjs           # count only (dry run)
//   node scripts/player-map/purge-heuristic-player-map.mjs --commit    # actually delete
//
