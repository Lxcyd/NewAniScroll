...
//
//   node scripts/inspect-player-map.mjs 16498          # show rows
//   node scripts/inspect-player-map.mjs 16498 --purge   # delete rows
//
...
if (!aniId) {
  console.error("usage: node scripts/inspect-player-map.mjs <aniId> [--purge]");
  process.exit(2);
}
