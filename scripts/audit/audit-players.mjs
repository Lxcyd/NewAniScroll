 ...
 *
 * Usage:
 *   node scripts/audit/audit-players.mjs                       # full, dev site
 *   node scripts/audit/audit-players.mjs --limit=50
 *   node scripts/audit/audit-players.mjs --id=178025           # one anime
 *   node scripts/audit/audit-players.mjs --only=animesama      # one source
 *   node scripts/audit/audit-players.mjs --lang=vostfr         # one language
 *   node scripts/audit/audit-players.mjs --concurrency=4
 *   node scripts/audit/audit-players.mjs --min-popularity=5000 # only popular titles
 *   node scripts/audit/audit-players.mjs --site=https://aniscroll.com
 *   node scripts/audit/audit-players.mjs --out=scripts/out/player-audit.json
 *
 * Env:
