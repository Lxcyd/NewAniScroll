 ...
 *
 * Usage:
 *   node scripts/drop-fanarts-from-cache.mjs           # dry-run by default
 *   node scripts/drop-fanarts-from-cache.mjs --confirm # actually drop
 */
...
if (!CONFIRM) {
  ...
  console.log("  node scripts/drop-fanarts-from-cache.mjs --confirm");
  process.exit(0);
}
