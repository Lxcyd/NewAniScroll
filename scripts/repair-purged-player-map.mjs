...
//
//   node scripts/seed-player-map.mjs --dump=scripts/out/_seed-reference.json
//   node scripts/repair-purged-player-map.mjs             # report only
//   node scripts/repair-purged-player-map.mjs --apply     # restore them
//
