...
export const BADGES: BadgeDef[] = [
  ...
  { id: "by-the-end", family: "episodes", rarity: "u", icon: "swap", tag: "", metric: {"k":"flag","name":"byTheEnd","n":1} },
  ...
  { id: "first-add", family: "discovery", rarity: "c", icon: "bookmark", tag: "", metric: {"k":"flag","name":"firstAdd","n":1} },
  ...
  { id: "one-sitting", family: "discovery", rarity: "r", icon: "flame", tag: "", metric: {"k":"flag","name":"oneSitting","n":1} },
  ...
  { id: "ghibli-1", family: "secret", rarity: "u", icon: "movies", tag: "", metric: {"k":"works","key":"ghibli","mode":"any","n":1}, secret: true },
  { id: "ghibli-10", family: "secret", rarity: "l", icon: "movies", tag: "10", metric: {"k":"worksCount","key":"ghibli","n":10}, secret: true },
