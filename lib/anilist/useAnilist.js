...
// A positive notice (e.g. "Progress Updated"). Goes through the unified notice
// store, so it joins the same animated stack as every other notice — including
// the player's, which the global <NoticeStack> portals into the player while
// it's fullscreen. No more CustomEvent bridge / sonner fallback.
