 ...
 * localStorage on this device only, and /en/my-list is the page that reads it —
 * the same shell as a profile, named for what it is. Linking them to a public
 * profile route would 404.
 */
