...
export async function extractSibnet(embedUrl) {
  try {
    ...
    /* `transient` separates the two failures that used to look identical to the
       ...
       2026-08-08: sibnet started answering 403 on shell.php from our egress
       (residential, Vercel and Cloudflare alike; a VPN exit still plays), which
       turned every sibnet episode into a "proven absence" and cached it.
