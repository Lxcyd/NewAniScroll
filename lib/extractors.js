...
// ── Vidmoly (vidmoly.to / .net / .biz — and ansembed.net) ─────────
...
export const VIDMOLY_HOST_RE = /(vidmoly\.(?:to|biz|net)|ansembed\.net)/i;
...
export function getExtractor(url) {
  ...
  // ansembed.net is Vidmoly white-labelled — same page, same m3u8 (see
  // VIDMOLY_DOMAINS). Without this it fell through to the generic JW Player
  // extractor, losing the domain-retry and Worker tiers.
