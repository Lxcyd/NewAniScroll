...
const SERVERS = [
  ...
  //
  // Ce qu'il faut RALLUMER si megaplay redevient lisible : cette entree, et
  // c'est tout — la branche `megaplay` de pages/api/v2/source, l'extracteur et
  // les temps de saut (`intro`/`outro`, toujours en clair, toujours utilises
  // par /api/v2/skip) sont restes en place et intacts.
