...
const SERVERS = [
  ...
  // `lecteurExterne: true` — le SEUL serveur qui remplace notre lecteur par
  // celui d'un tiers, avec son habillage, ses publicites et ses sous-titres
  // anglais. La consequence a corriger : un clic sur ce chip appelait
