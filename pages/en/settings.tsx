        ...
        <div className="max-w-screen-md w-full px-4 py-10">
          ...
          <section className="mb-10">
            ...
            <div className="rounded-xl bg-white/5 ring-1 ring-white/10 px-4 divide-y divide-white/5">
              <Toggle
                label={t("settings.player.autoSkipIntro")}
                desc={t("settings.player.autoSkipIntroDesc")}
                checked={playerPrefs.autoSkipIntro}
                onChange={(v) => setPlayerPrefs({ autoSkipIntro: v })}
              />
              <Toggle
                label={t("settings.player.autoSkipOutro")}
                desc={t("settings.player.autoSkipOutroDesc")}
                checked={playerPrefs.autoSkipOutro}
                onChange={(v) => setPlayerPrefs({ autoSkipOutro: v })}
              />
              <Toggle
                label={t("settings.player.autoNextEpisode")}
                desc={t("settings.player.autoNextEpisodeDesc")}
                checked={playerPrefs.autoNextEpisode}
                onChange={(v) => setPlayerPrefs({ autoNextEpisode: v })}
              />
            </div>
