      ...
      >
        ...
        <div className="relative flex items-center w-full gap-6 min-h-[48px]">
          ...
          <div className="flex shrink-0 items-center gap-4">
            ...
            {/* (Une pastille comptant les badges non vus a vecu ici le temps d'un
                aller-retour, le 23/09 : un chiffre de plus sur l'avatar, pour une
                chose qu'on decouvre tres bien en ouvrant l'onglet.) */}
