...
export const SHORTCUT_ICONS: Record<ShortcutAction, ReactNode> = {
  ...
  // Party chat: Material "chat" bubble with text lines (supplied by the user),
  // remapped from its 0 -960 960 960 viewBox into 0 0 24 24 via
  // translate(0,24) scale(0.025).
  partyChat: (
    <g transform="translate(0,24) scale(0.025)" fill="currentColor">
