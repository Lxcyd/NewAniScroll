  ...
  return (
    ...
    <div className="relative z-10 flex flex-col gap-4 font-karla">
      ...
      <div className="flex flex-wrap gap-5">
        ...
        {/* Ecarts fixes, contenu cale en haut. Une premiere version repartissait
            l'espace restant (justify-between) : les trois blocs flottaient a des
            distances differentes selon la longueur du titre, ce qui se voyait.
            C'est le TITRE qui occupe la hauteur de la jaquette, pas les vides —
            voir sa taille dans [...info].js. */}
        <div className="flex min-w-0 grow basis-[300px] flex-col gap-3.5">
          {title}
