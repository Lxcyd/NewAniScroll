              ...
              >
                ...
                <img
                  ...
                  /* CF transformation quota exhausted → proxied URL 429s →
                     ...
                     quota-free) instead of showing a broken image. */
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                >
                  <svg
                    ...
                    strokeWidth={2}
                    style={{
                      // No pop animation: the favourite state is known up
                      // front (whole-list cache), so the heart should just be
                      // there instantly rather than animating on every load.
